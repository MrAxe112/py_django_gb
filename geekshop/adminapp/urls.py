...
urlpatterns = [
    ...
    path('users/', adminapp.UserListView.as_view(), name='users_list'),
    ...
    path('categories/', adminapp.CategoriesListView.as_view(), name='category_list'),
    ...
    path('products/details/<int:pk>/', adminapp.ProductDetailView.as_view(), name='product_details'),
]
